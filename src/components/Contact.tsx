  ...
  return (
    <section id="contact" className="py-24 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-4 font-display text-gray-900">Reserva tu Habitación</h2>
          <p className="text-xl text-gray-600 font-sans">Completa el formulario para agilizar el proceso de alquiler. Un agente de Match4Rooms te contactará de inmediato.</p>
        </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col gap-2">
              <label className="font-semibold text-gray-700 font-sans">Universidad o zona de interés</label>
          ...
          <div className="flex flex-col gap-2">
            <label className="font-semibold text-gray-700 font-sans">Presupuesto mensual estimado</label>
